...
function Create() {
  ...
  <div className="form-group form-elements">
    ...
    <input type="text" className="form-control" id="exampleFormControlInput1" ref = {titleref} placeholder="enter challenge title"/>
  </div>
...
<input type="date" id="birthday" ref = {endref}  name="birthday"/>
  ...
  <div className="form-group form-elements">
    ...
    <textarea className="form-control" id="exampleFormControlTextarea1" ref = {descref}  rows="3"></textarea>
  </div>
...
<button style={{border:"1.5px solid grey",color:"black",marginLeft:"5px"}} onClick={uploadImage}>UploadImage</button>
  ...
  <div className="form-group form-elements">
    ...
    <select className="form-control" ref = {levelref}  id="exampleFormControlSelect1">
      <option>Easy</option>
